...
func main() {
	...
	// Flag for research scraping
	research := flag.Bool("research", false, "Alongside -scrape, signifies that research labs and centers should be scraped.")
	...
	case *scrape:
		...
		case *research:
			scrapers.ScrapeResearch(*outDir)
		default:
